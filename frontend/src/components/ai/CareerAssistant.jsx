...
import { Mic, MicOff, Send, Download, Loader2, MessageCircle, User } from 'lucide-react';
...
const CareerAssistant = () => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'ai',
      content: 'Hello! I\'m your AI Career Assistant. I can help you with career guidance, CV optimization, interview preparation, and job search strategies. What would you like to know?',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await chatWithCareerAssistant(inputMessage);
      const aiMessage = {
        id: Date.now() + 1,
        type: 'ai',
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.save('career-assistant-chat.pdf');
      ...
      <div className="p-4 border-t">
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            disabled={!inputMessage.trim() || careerChatLoading}
